export default function Perks({ selected, onChange }) {
  function handleCbClick(e) {
    ...
    // onChange([...selected, name]); //this only checks if the state of the box has changed and not whether is checked
  }
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-2">
      <div className="border flex p-4 rounded-lg items-center">
